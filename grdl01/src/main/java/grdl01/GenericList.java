...
public class GenericList {
	...
	/**
	 * Default add method. Add x to the end of this IntList. Size of the list goes
	 * up by 1.
	 * 
	 * @param x
	...
	/**
	 * Insert obj at position pos. post: get(pos) = x, size() = old size() + 1
	 * 
	 * @param pos
	 *            0 <= pos <= size()
	 * @param obj
	...
	/**
	 * Constructor to allow user of class to specify initial capacity in case they
	 * intend to add a lot of elements to new list. Creates an empty list.
	 * 
	 * @param initialCap
	 *            > 0
	 */
	 ...
	 * 
	 * @param other
	 *            The object to comapre to this
	 * @return true if other is a non null, IntList object that is the same size as
	 *         this IntList and has the same elements in the same order, false
	 *         otherwise.
	 */
